...
export default class UpdateIqDataView extends Component {
    constructor() {
        super();
        this.state = {
            redirect: false,
    ...
    setData = (page) => {
        ...
        const url = Constants.API_URL + "/billing/fetch-edb-macro4-update-iq-data";
    ...
    exportData = () => {
        ...
        const url = Constants.API_URL + "/billing/export-billing-data?billing_type=iq_billing";
                    ...
                    <div id="content-wrapper">
                        <div className="container-fluid">
                            <ol className="breadcrumb box-shadow">
                                ...
                                <li className="breadcrumb-item active">Monthly Detail Billing / Update Iq Data</li>
                            </ol>
                        </div>
                            ...
                            <div className="container-fluid tab-pane fade show active" id="executive-monthly-summary-output" role="tabpanel" aria-labelledby="executive-monthly-summary-output-tab">
                                ...
                                <div className="card mx-auto">
                                    <div className="card-header">
                                        <div className="row">
                                            <div className="col-md-6"><h5>Iq Billing Data</h5></div>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <tbody>
                                                    {
                                                        data.iq_billing_output && data.iq_billing_output.map((object, i) =>
                                                            <tr key={"tr-" + i}>
                                                                <td>{object.billing_cat}</td>
                                                                <td>{object.company_iq}</td>
                                                                <td>{object.office}</td>
                                                                <td>{object.formatted_id}</td>

                                                                <td>{object.summary}</td>
                                                                <td>{object.name}</td>
                                                                <td>{object.plan_estimate}</td>
                                                                <td>{object.date}</td>
                                                                <td>{object.owner}</td>
...

                                                    {
                                                        ...
                                                        data.iq_billing_output.length == 0 && <tr key="tr-1" ><td colSpan="9"><div key="div-1" align="center">No results found</div></td></tr>
