...
export default class EventDetailBilling extends Component {
    constructor() {
        super();
        this.state = {
            redirect: false,
    ...
    setData = (page) => {
        ...
        const url = Constants.API_URL + "/billing/fetch-event-detail-billing-data?page=" + page;
    ...
    exportData = () => {
        ...
        const url = Constants.API_URL + "/billing/export-billing-data?billing_type=event_detail_billing";
                    ...
                    <div id="content-wrapper">
                        <div className="container-fluid">
                            <ol className="breadcrumb box-shadow">
                                ...
                                <li className="breadcrumb-item active">Event Detail Billing </li>
                            </ol>
                        </div>
                        <div className="container-fluid">
                                        ...
                                        <table className="table table-bordered" id="dataTable" width="100%"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Hrs Applied To Pkg</th>
                                                    <th>Pkg Hrs Remaining</th>
                                                    <th>Hrs Charged_Above Pkg</th>
                                                    <th>Hrs To Be Billed</th>
