...
const ManageModal = (props) => {
    ...
    let initialFormData = {
        //id:props.id || "",
        color_name: props.data.formData.color_name || "",
    ...
    const handleSubmit = (e) => {
        ...
        if (props.data.formFrom == "create") {
            ...
            url = Constants.API_URL + "/colors/" + props.data.formFrom;
            method = "PUT";
        }
                            ...
                            <div className="form-row">
                                <div className="col-md-12">
                                    <div className="form-label-group">
                                        <input name="color_name" value={formData.color_name} onChange={handleInputChange} type="text" className={"form-control " + (errorData.color_name ? 'is-invalid' : '')} autoFocus="autofocus" />
                                        <label htmlFor="color_name">Enter Color Name</label>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default class ColorManagement extends Component {
    constructor() {
        super();
        this.state = {
            redirect: false,
    ...
    setData = (page) => {
        ...
        const url = Constants.API_URL + "/colors/?page=" + page + "&perPage=" + this.state.paginateData.itemsCountPerPage;
    ...
    removeData(obj) {
        if (window.confirm("Are you sure? There is no redo!")) {
            ...
            const url = Constants.API_URL + "/colors/" + id;
